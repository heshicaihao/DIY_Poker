package com.wlzndjk.poker.fragment;
...
import com.wlzndjk.poker.ad.AutoScrollViewPager;
import com.wlzndjk.poker.ad.CirclePageIndicator;
import com.wlzndjk.poker.ad.ImagePagerAdapter;
import com.wlzndjk.poker.adapter.HomeListAdapter;
import com.wlzndjk.poker.base.BaseFragment;
import com.wlzndjk.poker.bean.ADBean;
...
public class MainFragment extends BaseFragment implements OnClickListener {
	...
	private void initData() {
		...
		if (!AndroidUtils.isNetworkAvailable(getActivity())) {
			...
			mTime = getTime();
			LogUtils.logd(TAG, "mTimeupdatetimetime:" + mTime);
			initAdInfo();
			initCatList();
		}
	}
	...
	private void initCatList() {
		NetHelper.getMainList(mTime, new AsyncHttpResponseHandler() {
...
//		mListView.addHeaderView(mHeader);
	...
	private void setADinfo(JSONObject result) throws JSONException {
		...
		JSONObject promoter = result.optJSONObject("promoter");
		if(promoter!=null){
		...
		String time =  result.optString("updatetime");
		LogUtils.logd(TAG, "updatetimetime:" + time);
		FileUtil.saveFile(time,MyConstants.TIME,
				MyConstants.UPDATE_TIME, MyConstants.TXT);
	}
