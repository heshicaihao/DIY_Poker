...
import com.wlzndjk.poker.activity.GoodsDetailsActivity;
...
public class SonCatListAdapter extends BaseAdapter {
	...
	public SonCatListAdapter(Activity mActivity, Context context,
			JSONArray jsonArray) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.item_son_cat_list, null);
