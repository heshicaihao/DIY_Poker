...
import com.wlzndjk.poker.pay.ALiPay;
import com.wlzndjk.poker.pay.WechatPay;
...
public class OrderPayActivity extends BaseActivity implements OnClickListener {
	...
	private void onOnClickDepositPay() {
		if (mBalanceD < mTotalD) {
			if (!mIsDeposit_pay) {
				mDepositIV.setImageResource(R.drawable.checkbox_pressed);
				mAliIV.setImageResource(R.drawable.checkbox_pressed);
				mWXIV.setImageResource(R.drawable.checkbox_normal);
				mIsDeposit_pay = true;
				mIsAliPay = true;
				...
				mDepositIV.setImageResource(R.drawable.checkbox_normal);
				mAliIV.setImageResource(R.drawable.checkbox_pressed);
				mWXIV.setImageResource(R.drawable.checkbox_normal);
