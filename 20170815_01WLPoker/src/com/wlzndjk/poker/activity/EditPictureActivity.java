...
import com.wlzndjk.poker.utils.AndroidBug54971Workaround;
...
import com.wlzndjk.poker.utils.MyBitmapUtils;
...
public class EditPictureActivity extends BaseActivity implements
	...
	private void initData() {
		...
		try {
			...
			if (mPage == 2) {
				mShadowImage.setBackgroundResource(R.drawable.cs_szt);
				boreW = MyConstants.SZTBOREWIDTH;
				boreH = MyConstants.SZTBOREHEIGHT;
			} else {
				mShadowImage.setBackgroundResource(R.drawable.cs);
