...
import com.wlzndjk.poker.dialog.UploadCustomDialog;
import com.wlzndjk.poker.fragment.BrowseFragment;
...
import com.wlzndjk.poker.utils.StandardPokerDataUtils;
import com.wlzndjk.poker.utils.ToastUtils;
import com.wlzndjk.poker.widget.MyHScrollView;
...
//		AndroidBug54971Workaround.assistActivity(findViewById(android.R.id.content));
	...
	private void initView() {
		...
		Drawable drawableBack= getResources().getDrawable(R.drawable.browse_back);  
		...
		Drawable drawableSave= getResources().getDrawable(R.drawable.save);  
		...
		Drawable drawableBuy= getResources().getDrawable(R.drawable.buy);  
