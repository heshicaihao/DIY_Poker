...
import com.wlzndjk.poker.activity.AboutMeActivity;
import com.wlzndjk.poker.activity.ApplyPromoterActivity;
import com.wlzndjk.poker.activity.LoginActivity;
import com.wlzndjk.poker.activity.ManageAddressActivity;
import com.wlzndjk.poker.activity.MeActivity;
import com.wlzndjk.poker.activity.OrderActivity;
import com.wlzndjk.poker.activity.PopularizeActivity;
import com.wlzndjk.poker.activity.RegisterActivity;
import com.wlzndjk.poker.activity.SettingActivity;
import com.wlzndjk.poker.activity.WorksActivity;
...
import com.wlzndjk.poker.fragment.MainFragment;
import com.wlzndjk.poker.frame.MenuDrawer;
import com.wlzndjk.poker.frame.Position;
import com.wlzndjk.poker.jpush.ExampleUtil;
import com.wlzndjk.poker.jpush.LocalBroadcastManager;
...
import com.wlzndjk.poker.utils.NetworkStateService;
...
public class MainActivity extends BaseActivity implements OnClickListener {
	...
	private static final String STATE_ACTIVE_POSITION = "com.wlzndjk.poker.MainActivity.activePosition";
	private static final String STATE_CONTENT_TEXT = "com.wlzndjk.poker.MainActivity.contentText";
		...
		if (mUser.isIs_login()) {
			...
			if (!StringUtils.isEmpty(head_portrait)) {
				Glide.with(this).load(head_portrait)
						.placeholder(R.drawable.man_head).crossFade()
						.into(mMan_head);
			}
		} else {
			mMan_head.setImageResource(R.drawable.man_head);
		}
