...
public class MyURL {
	...
	// (36)获取优惠券价格信息
	public static final String GETCOUPON_URL = ConfigURL.URL
			+ "api.php/orders/get_ticket_info";

	// (37)主分类列表
	public static final String MAIN_CAT_URL = ConfigURL.URL
			+ "api.php/goods/get_main_cat_list";
	
	// (38)主分类列表
	public static final String SON_CAT_URL = ConfigURL.URL
			+ "api.php/goods/get_son_catlist";
