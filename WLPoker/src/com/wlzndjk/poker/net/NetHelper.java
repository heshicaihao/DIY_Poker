...
public class NetHelper {
	...
	public static void getCheckCost(String account_id, String account_token,
			String shipping_id, String address_id, String coupon_num,
			String objects, AsyncHttpResponseHandler handler) {
		RequestParams params = new RequestParams();
		params.put("account_id", account_id);
		params.put("account_token", account_token);
	 ...
	 */
	public static void getCheckCost(String account_id, String account_token,
			String shipping_id, String address_id,
			String objects, AsyncHttpResponseHandler handler) {
		RequestParams params = new RequestParams();
		params.put("account_id", account_id);
		params.put("account_token", account_token);
	...
	public static void createOrders(String account_id, String account_token,
			...
			String recommended_code, String memo,String coupon_num,
			AsyncHttpResponseHandler handler) {
	 ...
	 * @param handler
	 */
	public static void getCouponInfo(String coupon_num,
			AsyncHttpResponseHandler handler) {
		RequestParams params = new RequestParams();
		params.put("coupon_num", coupon_num);
		HttpClient.post(MyURL.GETCOUPON_URL, params, handler);
	}
	 ...
	 * @param handler
	 */
	public static void getMainList(String goods_updatetime,
			AsyncHttpResponseHandler handler) {
		RequestParams params = new RequestParams();
		/*params.put("goods_updatetime", goods_updatetime);*/
		HttpClient.post(MyURL.MAIN_CAT_URL, params, handler);
	}
	 ...
	 * @param handler
	 */
	public static void getSonList(String goods_updatetime,String main_cat_id,
			AsyncHttpResponseHandler handler) {
		RequestParams params = new RequestParams();
/*		params.put("goods_updatetime", goods_updatetime);*/
		params.put("main_cat_id", main_cat_id);
		HttpClient.post(MyURL.SON_CAT_URL, params, handler);
	}
