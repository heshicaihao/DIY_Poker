...
public class SharedpreferncesUtil {
	...
	public static final String USER_LOGOUT_FILE_NAME = "logout"; 
	/**
	 * 保存用户信息
	 * 
	 * @param context
	 ...
	 * @param context
	 */
	public static void setProofLogin(Context context,boolean islogout) {
		SharedPreferences prefe = context.getSharedPreferences(
				USER_LOGOUT_FILE_NAME, 0);
		Editor editor = prefe.edit();
	 ...
	 * @return
	 */
	public static boolean getProofLogin(Context context) {
		SharedPreferences prefe = context.getSharedPreferences(
				USER_LOGOUT_FILE_NAME, 0);
		boolean b = prefe.getBoolean("islogout", false);
		return b;
	}
