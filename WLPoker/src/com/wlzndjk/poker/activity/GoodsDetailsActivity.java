...
import com.wlzndjk.poker.adapter.GoodsDetailsListAdapter;
import com.wlzndjk.poker.adapter.PopupHolder;
...
import com.wlzndjk.poker.widget.MyListView;
import com.wlzndjk.poker.widget.SildingFinishLayout;
import com.wlzndjk.poker.widget.SildingFinishLayout.OnSildingFinishListener;
...
//			FileUtil.saveFile(json, MyConstants.HOMEAD,
//					"NewGoodsList", MyConstants.TXT);
		...
		public void onClick(View view) {
			...
			case R.id.ok_btn:
				...
				if (mUser.isIs_login()) {
					...
					AndroidUtils.enterActvityAnim(GoodsDetailsActivity.this);
				}
				break;
			default:
				break;
	...
	class PopupListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (clickTemp == position) {
				holder.titleImageView.setImageResource(R.drawable.pic_pressed);
				...
				holder.titleImageView.setImageResource(R.drawable.pic_normal);
				holder.frameRelativeLayout
