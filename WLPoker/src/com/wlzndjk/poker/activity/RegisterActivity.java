...
public class RegisterActivity extends BaseActivity implements OnClickListener,
	...
	private String mPromoteCodeStr;
	...
	public void onClick(View view) {
		...
		mPromoteCodeStr = mPromoCodeET.getText().toString().trim();
		...
		case R.id.register:
			...
			if (AndroidUtils.isNoFastClick()) {
				...
				mDialog.show();
				register(mPhoneStr, mAuthcodeStr, mPasswordStr, mPromoteCodeStr);
			}
			break;
	...
	private boolean proofInputInfo() {
		...
		if (StringUtils.isEmpty(mPromoteCodeStr)) {
